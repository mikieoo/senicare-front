...
export default function HRDetail() {
    ...
    // state: 요양사 아이디 상태 // 
    const { userId } = useParams(); //경로 변수를 가지고 오는 것
    ...
    const onUpdateCancelClickHanler = () => {
        setUpdate(false);
    }
        ...
        <div id='hr-detail-wrapper'>
            ...
            <div className='bottom'>
                ...
                <div className='button-box'>
                    <div className='button disable' onClick={onUpdateCancelClickHanler}>취소</div>
                    <div className='button second' onClickCapture={onUpdateButtonClickHandler}>저장</div>
                </div>:
